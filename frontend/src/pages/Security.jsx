...
const Security = () => {
    ...
    const entervisitordata=async(e)=>{
        ...
        try{
          ...
          const response = await axios.post('security/security_visitor_add',visitorobj);
    ...
    const updatevisitordata=async()=>{
        ...
        try{
            ...
            const response = await axios.post('security/security_visitor_update',updatevisitorobj);
        }
        catch(error){
            console.log(error);
        }
                    ...
                    <div className="flex justify-center -mx-3 mb-6">
                        ...
                        <div className="w-full md:w-1/2 px-3">
                            ...
                            <input
                                ...
                                onChange = {(e)=>setvisitorFname(e.target.value)}
                            />
                        </div>
                        <div className="w-full md:w-1/2 px-3">
                            <label
